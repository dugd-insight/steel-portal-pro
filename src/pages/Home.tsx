        ...
        <div className="about-preview-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64, alignItems: 'center' }}>
          <div>
            ...
            <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap' }}>
              ...
              <Link to="/about/culture" className="btn btn-outline">
                {t('about.tabs.culture')}
              </Link>
              <Link to="/about/certificates" className="btn btn-outline">
                {t('about.tabs.certificates')}
              </Link>
              <Link to="/about/why-us" className="btn btn-outline">
                {t('about.tabs.whyUs')}
              </Link>
            </div>
          </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
              ...
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: 16 }}>
                ...
                <div>
                  ...
                  <p style={{ color: 'var(--text-secondary)', fontSize: 14 }}>sales@luxi-supply.com<br />support@luxi-supply.com</p>
                </div>
              </div>
